...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Suggest shows to watch, add shows to the watchlist from recently watched shows and suggested shows. User viewing activity is logged to keep track of episodes watched.",
      image: streamwakeImg,
