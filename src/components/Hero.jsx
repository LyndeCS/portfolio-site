    ...
    <section className="bg-smoke-500 text-white pt-32">
      <div className="container mx-auto flex items-center justify-stretch">
        <div className="w-1/2">
          ...
          <p className="text-2xl mb-10 text-white opacity-50">
            I'm passionate about creating stylish and intuitive solutions.
          </p>
          <a
            href="#portfolio"
            className="rounded-md px-32 bg-transparent border border-meadow-500 text-white py-3 text-2xl transition-all duration-500 hover:bg-meadow-100 hover:bg-opacity-5"
          >
            See My Work
          </a>
        </div>
