...
const Hero = () => {
	return (
		<section className="bg-smoke-500 text-white xl:pt-12 2xl:pt-32 pb-4 md:pb-0 h-[80vh] xl:h-[65vh] flex flex-col justify-center">
			<div className="container mx-auto flex items-center">
				...
				<div className="w-full xl:w-1/2 text-center xl:text-start">
					...
					<h2 className="text-5xl xs:text-6xl sm:text-8xl font-bold mb-12 lg:mb-6">
						<span className="text-meadow-500">Christopher</span>.
					</h2>
					<h3 className="text-3xl xs:text-4xl sm:text-6xl mb-12 sm:mb-8">
						I'm a web developer
						<br /> from London, Ontario.
					</h3>
					<p className="text-md xs:text-lg sm:text-2xl mb-12 xl:mb-10 text-white opacity-50 px-4 xl:px-0">
