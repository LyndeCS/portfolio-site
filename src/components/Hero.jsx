...
const Hero = () => {
  return (
    <section className="bg-smoke-500 text-white pt-40 min-h-screen">
       <div className="container mx-auto flex items-center justify-stretch">
        ...
        <p className="text-2xl mb-10 text-slate-400">I'm passionate about creating stylish and intuitive solutions.</p>
          <a href="#portfolio" className="px-32 bg-transparent border border-meadow-500 text-white py-3 rounded text-2xl transition-all duration-700 hover:bg-meadow-100 hover:bg-opacity-5">See My Work</a>
        </div>
